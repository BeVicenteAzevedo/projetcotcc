      ...
      <form action="evento.php" method="get">
        ...
        <div class="info">
            <label>Nome do evento:</label>
                <input class="fname" type="text" name="nome_evento" placeholder="Nome do Evento" maxlength="20" required>
            ...
            <select id="cidade" name="cidade">
                ...
                <!-- <input type="text" name="cidade" placeholder="Niterói" required> -->
            <label>Data: </label>
                <input type="date" name="data_evento" placeholder="" class="espec" required min="2023-01-04">
            <label>Hora: </label>
                <input type="time" name="hora" placeholder="" class="espec" required>
            <label>Preço: </label>
                <input type="text" name="preco" placeholder="R$90,00" required>
            ...
            <label>Autor: </label>
                <input required name='autor' value='<?php echo $_SESSION['login']?>'>
